...
public class ShortTruthTableView extends GridBoardView
{
    ...
    public ShortTruthTableView(Dimension gridSize)
    {
        ...
        for(int i = 0; i < gridSize.height; i++)
        {
            for(int k = 0; k < gridSize.width; k++)
            {
                ...
                ShortTruthTableElement element = new ShortTruthTableElement(new ShortTruthTableCell(0, null));
    ...
    public DataSelectionView getSelectionPopupMenu()
    {
        ...
        for (int r = 1; r <= 3; r++)
        {
            for (int c = 1; c <= 3; c++)
            {
                ShortTruthTableElement element = new ShortTruthTableElement(new ShortTruthTableCell((r - 1) * 3 + c, null));
